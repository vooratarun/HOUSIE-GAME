...
*/
  ...
  function onMouseUp (e) {
    e.preventDefault();
    lineTo(position.x, position.y);   // no problem if we remove also.
...
// drawing  board and colors and sizes array functioning and keyboard events for sizes and colors changing. 
(function(){
