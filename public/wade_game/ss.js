App = function()
{
    ...
    $(document).keyup( function(e){
        left = shipObject_up1.pos;
        var angle = shipObject_up1.angle;

        var end1 =shipObject_up1.getPosition().x-80;

        var end2 = shipObject_up1.getPosition().x+80;
        arrow_angle = shipObject_up1.arrow_angle;
        ...
        switch(e.which) {
            ...
            case 37 :
            {
                if (left >= end1){
                left = left - 5;
                shipObject_up1.pos = left;
                shipObject_up1.angle = angle + 0.029352535;
                 shipObject_up1.arrow_angle = arrow_angle +  0.029352535
                    movement(shipObject_up1);
                }
                break;
            ...
            case 38 :{
             // for(i=0;i<30000;i++){}
                bulletrelease3(left,0,shipObject_up1);
                break;
    ...
    function create_enemy_bullet() {
        ...
        enemySprite.setSize(70, 70);
         enemyObject = new SceneObject(enemySprite, 0,100  ,50 );
    ...
    function bulletrelease(startX,startY,shipObject)
    {
        ...
        var overlapping = shipObject_up4.getOverlappingObjects();

        for(var i=0 ;i< overlapping.length;i++)
        {
            if(overlapping[i].isBullet)
            {
                var position = overlapping[i].getPosition();
        ...
        var chickenoverlap = enemyObject.getOverlappingObjects();
        for( var i= 0; i<chickenoverlap.length;i++ )
        {
            if(chickenoverlap[i].isBullet)
            {
                wade.removeSceneObject(enemyObject);
                var position = chickenoverlap[i].getPosition();
                ...
                if(shipObject.pid == 1)
                {
                    ...
                    after  = new SceneObject(newsprite,0,position.x,position.y);
    ...
    function bulletrelease3(startX,startY,shipObject)
    {
        ...
        var overlapping = shipObject4.getOverlappingObjects();
    ...
    function bulletrelease4(startX,startY,shipObject)
    {
        ...
        var overlapping = shipObject1.getOverlappingObjects();
